...
function FamilySectionContent({ side }: { side: WeddingSide }) {
  ...
  return (
    <section className="bg-wedding-cream-dark py-16 sm:py-24 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 bg-white/40 p-8 sm:p-12 rounded-[2rem] border border-wedding-red/5 shadow-inner">
        ...
        {guestName && (
          ...
          >
            <p className="text-wedding-gray text-[10px] sm:text-xs tracking-[0.2em] uppercase mb-1">Trân trọng kính mời</p>
            <p className="text-wedding-red font-serif text-xl sm:text-3xl italic font-bold px-4 leading-tight">
              {guestName}
            </p>
            <p className="text-wedding-gray text-[10px] sm:text-xs mt-3 max-w-[280px] sm:max-w-none mx-auto opacity-70">
            ...
            <p className="text-wedding-dark font-serif text-[10px] sm:text-sm mt-1 opacity-80">
              {data.venue.address}
            </p>
          </motion.div>
        )}
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-12 text-center items-start border-t border-wedding-red/10 pt-12">
          
          {/* Nhà Gái */}
          <div className="space-y-6">
            <h3 className="text-wedding-red/50 font-serif text-[10px] sm:text-xs tracking-widest uppercase">Nhà Gái</h3>
          ...
          {/* Nhà Trai */}
          <div className="space-y-6">
            <h3 className="text-wedding-red/50 font-serif text-[10px] sm:text-xs tracking-widest uppercase">Nhà Trai</h3>
            <div className="space-y-2 font-serif text-[11px] sm:text-lg">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 text-center border-t border-wedding-red/10 pt-8"
        >
          ...
          <p className="text-wedding-gray font-serif text-[10px] sm:text-xs italic mt-1">
            (Nhằm {data.lunarDate})
          </p>
        </motion.div>
      </div>
